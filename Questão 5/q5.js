...
function mostrar_final(match) {
  ...
  resultado.innerHTML = ''; // Pega a div e deixa ela vazia.

  const data = new Date(match.datetime); // Cria um objeto a partir da data da partida.
...
}  // Função principal para mostrar as informações da partida final.
